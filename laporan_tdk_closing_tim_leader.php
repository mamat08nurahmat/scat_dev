...
header("Content-Disposition: attachment; filename=report_tl_tdk_closing.xls");
$i = 1;
if($level==1||$level==2)
{
...
<table width="663" border="0">
  <tr>
   <td colspan="10" style="background:#f5f5f5;text-align:center;">
		<span style="font-size:16px;">
		<strong>REPORT TIDAK CLOSING TIM LEADER SALES COMPANY  <br> PT. Bank Negara Indonesia </strong>
		</span>
   </td>
  </tr>
  <tr>
