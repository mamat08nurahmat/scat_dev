...
<table align ="left">
	...
	<table align="center">
		<tr><td>Jenis Kelamin</td>
			<td><input name="jenis_kelamin" type="radio" value="l" <? if($jenis_kelamin=='jenis_kelamin'){echo 'checked';}?>  readonly="readonly" />Laki-laki
		...
		<tr><td>No HP </td>
			<td><input name="hp" value="<?php echo $no_hp ?>"  title="No HP harus diisi" type="text" readonly="readonly" /></td>
		</tr>
...
<table border="1">
	...
	<tr>
        <td><input name="perusahaan" style="width:170px;" type="text" value="<?php echo $perusahaan ?>" readonly="readonly"></td>
		<td><input name="jabatan" style="width:110px;" type="text" value="<?php echo $jabatan ?>" readonly="readonly"></td>
		<td><input name="tgl_masuk" style="width:130px;" type="date" value="<?php echo $masuk ?>" readonly="readonly"></td>
		<td><input name="tgl_resign" style="width:130px;" type="date" value="<?php echo $resign ?>" readonly="readonly"></td>
        <td><input name="alasan" style="width:200px;" type="text" value="<?php echo $alasan ?>" readonly="readonly"></td>
	</tr>
	<tr>
        <td><input name="perusahaan1" style="width:170px;" type="text" value="<?php echo $perusahaan1 ?>" readonly="readonly"></td>
		<td><input name="jabatan1" style="width:110px;" type="text" value="<?php echo $jabatan1 ?>" readonly="readonly"></td>
		<td><input name="tgl_masuk1" style="width:130px;" type="date" value="<?php echo $masuk1 ?>" readonly="readonly"></td>
		<td><input name="tgl_resign1" style="width:130px;" type="date" value="<?php echo $resign1 ?>" readonly="readonly"></td>
        <td><input name="alasan1" style="width:200px;" type="text" value="<?php echo $alasan1 ?>" readonly="readonly"></td>
	</tr>
	<tr>
        <td><input name="perusahaan2" style="width:170px;" type="text" value="<?php echo $perusahaan2 ?>" readonly="readonly"></td>
		<td><input name="jabatan2" style="width:110px;" type="text" value="<?php echo $jabatan2 ?>" readonly="readonly"></td>
		<td><input name="tgl_masuk2" style="width:130px;" type="date" value="<?php echo $masuk2 ?>"readonly="readonly"></td>
		<td><input name="tgl_resign2" style="width:130px;" type="date" value="<?php echo $resign2 ?>" readonly="readonly"></td>
...
<p></p>	
	...
	<tr align ="center">
        <td colspan=4" style="background:#00BFFF">HISTORY</td>
		</tr>
		<tr align ="center">
...
?>
		...
		<table border="1" align="center">
	<tr align ="center">
        <td colspan="3" style="background:#00BFFF"> file yang di upload</td>
		</tr>
		<tr align ="center">
		<td style="width:170px;">KTP</td>
		<td style="width:170px;">PAS FOTO</td>
		<td style="width:170px;">KOMITMEN</td>
		<p></p>
    </tr>
		
		<tr align="center">
		
			<td><a href="uploads/photo/<?php echo $data['upload'];?>" class="btn " download>Download File</a></td>
			<td><a href="uploads/photo/<?php echo $data['photo'];?>" class="btn " download>Download File</a></td>
			<td><a href="uploads/photo/<?php echo $data['komitmen'];?>" class="btn " download>Download File</a></td>
		</tr>
		</table><br>
		<tr>
			<td><center><a href="index.php?page=10b" class="btn btn-danger" >kembali</a></center></td>
		</tr>
