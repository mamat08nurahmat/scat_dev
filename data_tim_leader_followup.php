...
<table class="table table-condensed table-bordered table-hover" cellpadding="0" cellspacing="0">
    ...
    <?php 
        $i = 1;
        $jml_per_halaman = 20;
        $jml_data = mssql_num_rows(mssql_query("SELECT * FROM ( SELECT id_report,ROW_NUMBER() OVER (ORDER BY nama_nasabah ASC) AS ROWNUM,nomor_pinjaman,no_rekening_affiliasi,nama_nasabah,persetujuan_pengalihan,nominal,no_perjanjian,no_rekening,keterangan,id_cabang,ket,tgl_update,outstanding
    ...
    <tr>
		...
		<td><?php echo $tgl ?></td>-->
        <td><center>
            <a href="#dialog-report-followup" id="<?php echo $data['id_report'] ?>" class="ubah" data-toggle="modal">
