...
$level=$_SESSION['user_level'];
	...
	elseif($level== 7 )
	{
	$cektipe='where id_cabang in (15,181,34,113,131,121,285,38,6,23,28,227,14,11,169,4)';
	}
	else
	{
...
<?php 
	...
	$follow = mssql_query("SELECT COUNT(*) AS total1 FROM report_tl where id_cabang='$_SESSION[id_cabang]' and persetujuan_pengalihan='1' and ket='1'");
	$fol 	= mssql_fetch_assoc($follow);
	$f		= $fol['total1'];
	
	$closing = mssql_query("SELECT COUNT(*) AS total2 FROM report_tl where id_cabang='$_SESSION[id_cabang]' and persetujuan_pengalihan='1' and ket='2' ");
...
<div class="container" style=" width:98%;">
	<div id="horizontalTab">
		<ul>
			...
			<li><a href="#tab-3"><i class="fa fa-check-square-o" style="font-size:25px"></i> CLOSING ( <?php echo $cl ?> )</a></li>
            <li><a href="#tab-4"><i class="fa fa-times-circle-o" style="font-size:25px"></i> TIDAK CLOSING ( <?php echo $t ?> )</a></li>
			<li><a href="#tab-5"><i class="fa fa-folder-o" style="font-size:25px"></i> REPORT</a></li>
        </ul>
        <div id="tab-1">
