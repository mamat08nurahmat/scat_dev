	...
	<div class="row" style="width:98%;margin-left:10px;">
		<h3>
			...
			<div class="input-prepend pull-left ">
				...
				<input class="span2" id="prependedInput" type="text" name="cari2" placeholder="Pencarian All...">
			</div>
			<a href="laporan_closing_tim_leader.php"><img src="images/excel-pipeline.png" style=" width:10%; height:10%; vertical-align: bottom; float:right;"></a>
		</h3>

		<!-- tempat untuk menampilkan data -->
		<div id="data-report-closing"></div>
	</div>
<!-- awal untuk modal dialog (ada di css dengan .modal)-->
<div id="dialog-report-closing" class="modal hide fade" style="width:60%" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
<script src="aplikasi.tl.closing.js"></script>
