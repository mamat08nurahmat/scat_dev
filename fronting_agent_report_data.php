...
if($perusahaan==1)
{
	$where="and p.nama_perusahaan is not null";
}
else
{
	$where ="and p.nama_perusahaan='$perusahaan'";
}
...
$sql=mssql_query(" SELECT 
					...
					WHERE p.bulan='$month' and p.tahun='$year' $where order by tgl_update ASC
					");
