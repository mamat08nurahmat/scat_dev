...
$sql="select max(npp) npp from temp_sales where len(npp) = 5 and id_grup in (8,9,11,12)"; /* selain sales harus lebih dari 5 digit */
...
<form class="form-horizontal" id="form-mahasiswa">
		...
		<div class="controls">
		<select name="id_grup" id="id_grup" disabled="true">
	...
	<div class="control-group">
		...
		<div class="controls">
		<select id="propinsi" name="propinsi" disabled="true">
...
<p>&nbsp;</p>
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" id="nama_sales" class="input-xlarge" name="nama_sales" disabled="true" value="<?php echo $nama_sales ?>"> * Wajib diisi nama sesuai KTP/SIM
		</div>
	</div>
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" disabled="true" id="nama_panggilan" class="input-xlarge" name="nama_panggilan" value="<?php echo $nama_panggilan ?>"> * Wajib diisi
		</div>
	</div>
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" disabled="true" id="ec_nama" class="input-xlarge" name="ec_nama" value="<?php echo $ec_nama ?>"> * Wajib diisi
		</div>
	</div>
	...
	<div class="control-group">
		...
		<div class="controls">
			<select class="input-medium" name="jenis" disabled="true">
				<?php 
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" disabled="true" id="tempat_lahir" class="input-xlarge" name="tempat_lahir" value="<?php echo $tempat_lahir ?>"> * Wajib diisi
		</div>
	</div>
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" disabled="true" id="kota_1" class="input-xlarge" name="kota_1" value="<?php echo $kota_1 ?>"> * Wajib diisi
		</div>
	</div>
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" disabled="true" id="kode_pos_1" class="input-xlarge" name="kode_pos_1" value="<?php echo $kode_pos_1 ?>"> * Wajib diisi
		</div>
	</div>
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" disabled="true" id="lama_tinggal_1" class="input-xlarge" name="lama_tinggal_1" value="<?php echo $lama_tinggal_1 ?>"> * Wajib diisi
		</div>
	</div>
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" disabled="true" id="status_tinggal" class="input-xlarge" name="status_tinggal" value="<?php echo $status_tinggal ?>"> * Wajib diisi
		</div>
	</div>
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" disabled="true" id="agama" class="input-xlarge" name="agama" value="<?php echo $agama ?>"> * Wajib diisi
		</div>
	</div>
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" disabled="true" id="telp_rumah" class="input-xlarge" name="telp_rumah" value="<?php echo $telp_rumah ?>"> * Wajib diisi
		</div>
	</div>
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" disabled="true" id="ibu" class="input-xlarge" name="ibu" value="<?php echo $ibu ?>"> * Wajib diisi
		</div>
	</div>	
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" disabled="true" id="telp_user_atasan" class="input-xlarge" name="telp_user_atasan" value="<?php echo $telp_user_atasan ?>"> * Wajib diisi
		</div>
	</div>		
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" disabled="true" id="email" class="input-xlarge" name="email" value="<?php echo $emailku ?>"> * Wajib diisi
		</div>
	</div>
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" disabled="true" id="kendaraan" class="input-xlarge" name="kendaraan" value="<?php echo $kendaraan ?>"> * Wajib diisi
		</div>
	</div>
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" disabled="true" id="no_ktp" class="input-xlarge" name="no_ktp" value="<?php echo $no_ktp ?>"> * Wajib diisi
		</div>
	</div>
	...
	<div class="control-group">
		...
		<div class="controls">
			<textarea disabled="true" id="alamat_1" name="alamat_1"><?php echo $alamat ?></textarea> * Wajib diisi alamat lengkap
		</div>
	</div>
	...
	<div class="control-group">
		...
		<div class="controls">
			<select class="input-medium" name="id_vendor" disabled="true" >
				<?php 
				// tampilkan untuk form ubah mahasiswa
				if($kd_npp > 0) { ?>
	...
	<div class="control-group">
		...
		<div class="controls">
			<select class="input-medium" name="status_sales" disabled="true" >
				<?php 
				// tampilkan untuk form ubah mahasiswa
				if($kd_npp > 0) { ?>
		...
		<div class="controls">
			<input type="text" disabled="true" id="id_user_atasan" class="input-medium" name="id_user_atasan" value="<?php echo $id_user_atasan ?>"> * Wajib diisi NPP penyelia
		</div>
	</div>
		<div class="control-group">
		<label class="control-label" for="id_user_leader">Leader</label>
		<div class="controls">
			<input type="text" disabled="true" id="id_user_leader" class="input-medium" name="id_user_leader" value="<?php echo $id_user_leader ?>"> * Wajib diisi nama team leader
		</div>
	</div>
		<div class="control-group">
		<label class="control-label" for="grade">Grade</label>
		<div class="controls">
			<select class="input-medium" name="grade" disabled="true" >
				<?php 
				// tampilkan untuk form ubah mahasiswa
				if($kd_npp > 0) { ?>
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" disabled="true" id="telepon" class="input-medium" name="telepon" value="<?php echo $telepon ?>"> *
		</div>
	</div>
	<div class="control-group">
		<label class="control-label" for="keterangan">Keterangan</label>
		<div class="controls">
			<textarea id="keterangan" disabled="true" name="keterangan"><?php echo $keterangan ?></textarea>
		</div>
	</div>
	<div class="control-group">
		...
		<div class="controls">
			...
			{
				?>
					<input type="text" disabled="true" id="tanggal_aktif" class="input-xlarge" name="tanggal_aktif" value="<?php echo $tanggal_aktif ?>"> *
				<?php
			}
			?>
		</div>
	...
	<div class="control-group">
		...
		<div class="controls">
			...
			{
			?>
			<input type="text" disabled="true" id="tanggal_resign" class="input-xlarge" name="tanggal_resign" value="<?php echo $tanggal_resign ?>">
			<?php
			}
			else
			{
				?>
				<input type="text" disabled="true" id="tanggal_resign" class="input-xlarge" name="tanggal_resign" value="<?php echo $tanggal_resign ?>" readonly="readonly"/>
				<?php
			}
			?>
		</div>
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" disabled="true" id="tanggal_buat" class="input-xlarge" name="tanggal_buat" value="<?php echo $date ?>">
		</div>
	</div>
	
	<div class="control-group">
		<label class="control-label" for="ket_tolak">Alasan</label>
		<div class="controls">
			<textarea id="ket_tolak" name="ket_tolak"><?php echo $ket_tolak ?></textarea>
		</div>
	</div>
