...
if(isset($_POST['hapus'])) {
	...
	if($npp!="" && $nama!="") {
		...
		if($kd_npp==0) {
			mssql_query("INSERT INTO sales(npp,id_grup,id_cabang,nama,tanggal_lahir,alamat,status,id_vendor,id_user_atasan,id_user_leader,grade,telepon,keterangan,tanggal_aktif,tanggal_resign,tanggal_buat,pass,status_sales,ket) 
