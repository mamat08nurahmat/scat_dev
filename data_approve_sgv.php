...
<body>
<div align="center" style="border:1px solid;background-color:#00BFFF"><strong><p>DATA APPROVE SGV</strong></p></div>
<p></p>
	<!--<div class="row" style="width:98%;margin-left:10px;">
		<h3>
			<div class="pull-right">
				<form action="index.php?page=10e" method="POST">
...
<thead>
	<tr bgcolor='#666666' align='center'>
		...
		<?php 
				$query_mssql = mssql_query("SELECT * FROM 
											(select id, id_grup,id_cabang, nama_lengkap , alamat ,hp , tgl ,ket 
											from contoh where ket=3 )As a
	...
	if($lama_approve==1){
		...
		<tr bgcolor="<?php echo $color ; ?>" >
			...
			<td><font color='black'><?php echo $data['nama_area']; ?></font> 
			<p><font color='black'><?php echo $data['nama_cabang']; ?></font></p></td>
			...
			<!-- sales approve sgv form -->
			<td><center><a class="btn" href="index.php?page=10f&id=<?php echo $data['id']; ?>">view</a></center></td>
		</tr>
		<?php } ?>
	</table>
