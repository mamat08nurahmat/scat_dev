...
<body>
	<div class="row" style="width:98%;margin-left:10px;">
		...
		<h3>
			...
			<div><a href="laporan_leads_cart.php"><img src="images/excel-pipeline.png" style=" width:10%; height:10%; vertical-align: bottom; float:right;"></a></div>		
		</h3>
		
		<!-- tempat untuk menampilkan data -->
		<div id="data-leads-cart"></div>
	</div>
...
<script src="aplikasi.leads.cart.js"></script>
