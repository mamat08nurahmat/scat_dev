...
$data = mssql_fetch_array(mssql_query("SELECT * FROM contoh a join app_user_grup b on a.id_grup = b.id_grup 
...
<table align ="left">
	...
	<table align="center">
		<tr><td>Jenis Kelamin</td>
			<td><input name="jenis_kelamin" type="radio" value="l" <? if($jenis_kelamin=='l'){echo 'checked';}?>  readonly="readonly" />Laki-laki
