...
<div id="dialog-approve" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	...
	<div class="modal-footer">
		...
		<button id="simpan-approve" class="btn btn-success">Simpan</button>
	</div>
</div>
...
<script src="aplikasi.approve.js"></script>
